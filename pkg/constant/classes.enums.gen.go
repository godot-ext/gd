...
const (
	...
	AUDIO_STREAM_INTERACTIVE_TRANSITION_FROM_TIME_TRANSITION_FROM_TIME_NEXT_BEAT                                          = 1
	AUDIO_STREAM_INTERACTIVE_TRANSITION_FROM_TIME_TRANSITION_FROM_TIME_NEXT_BAR                                           = 2
	AUDIO_STREAM_INTERACTIVE_TRANSITION_FROM_TIME_TRANSITION_FROM_TIME_END                                                = 3
)
...
const (
	...
	AUDIO_STREAM_INTERACTIVE_TRANSITION_TO_TIME_TRANSITION_TO_TIME_START                                                = 1
)
...
const (
	...
	AUDIO_STREAM_INTERACTIVE_FADE_MODE_FADE_IN                                       = 1
	AUDIO_STREAM_INTERACTIVE_FADE_MODE_FADE_OUT                                      = 2
	AUDIO_STREAM_INTERACTIVE_FADE_MODE_FADE_CROSS                                    = 3
	AUDIO_STREAM_INTERACTIVE_FADE_MODE_FADE_AUTOMATIC                                = 4
)
...
const (
	...
	AUDIO_STREAM_INTERACTIVE_AUTO_ADVANCE_MODE_AUTO_ADVANCE_ENABLED                                              = 1
	AUDIO_STREAM_INTERACTIVE_AUTO_ADVANCE_MODE_AUTO_ADVANCE_RETURN_TO_HOLD                                       = 2
)
